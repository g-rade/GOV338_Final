...
first_block <- sandy_relief %>% 
  ...
  summarize(number = n()) %>% 
  arrange(block, .by_group = F) ## looking at the storm membership by party for block 1
...
plot(blocks, labels=blocks$glabels, main="Subgroups for H.R. 152 and H.R. 5021", xlab="", ylab="", sub="")
